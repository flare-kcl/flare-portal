...
3. Make merge requests at e.g. https://git.torchbox.com/[client_name]/flare_portal, no trailing slash/merge_requests/new, setting the 'Source branch' to your feature branch and the 'Target branch' to `master`. Select 'Compare branches and continue'.
