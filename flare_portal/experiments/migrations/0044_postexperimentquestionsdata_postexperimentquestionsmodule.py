    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('heading', models.CharField(default='Review Questions', help_text='Title at the top of the questions screen', max_length=255)),
                ('experiment_unpleasant_rating', models.BooleanField(verbose_name='How unpleasant did you find the experiment with the loud noises?')),
                ('did_follow_instructions', models.BooleanField(verbose_name='Did you follow the instructions fully during the session?')),
                ('did_remove_headphones', models.BooleanField(verbose_name='Did you remove your headphones at any point during the experiment?')),
                ('did_pay_attention', models.BooleanField(verbose_name='Were you paying attention throughout the task where you were rating images?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('module', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='data', to='experiments.postexperimentquestionsmodule')),
