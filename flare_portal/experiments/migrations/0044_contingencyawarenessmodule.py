    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audible_keyword', models.CharField(help_text='Did you happen to notice whether you heard the ...... after seeing a certain stimuli?', max_length=255)),
                ('visual_keyword', models.CharField(help_text='Did you happen to notice whether you heard the sound after seeing a certain ......?', max_length=255)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('module', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='data', to='experiments.contingencyawarenessmodule')),
